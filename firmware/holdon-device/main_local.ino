...
const unsigned long SENSOR_PANIC_COOLDOWN_MS = 10000;
bool firstNotMovingSent = false;
String panicSource = "";
...
void updateButton() {
  ...
  if (stableButtonPressed &&
      !longPressStarted &&
      (state == STATE_ACTIVE || state == STATE_PANIC_MONITORING || state == STATE_NOT_MOVING) &&
